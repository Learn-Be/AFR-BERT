...
from Multimodal_BERT import BertForSequenceClassification, BertConfig, Weights_Name, Config_Name
...
def main(i):
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='Multimodal_BERT_Master/data/text', type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--bert_model", default='Multimodal_BERT_Master/pre-trained BERT', type=str,
                        help="Bert pre-trained model selected in the list: bert-base-uncased, "
                        "bert-large-uncased, bert-base-cased, bert-large-cased, bert-base-multilingual-uncased, "
                        "bert-base-multilingual-cased, bert-base-chinese.")
    parser.add_argument("--task_name", default='Multi', type=str,
                        help="The name of the task to train.")
    parser.add_argument("--output_dir", default='Multimodal_BERT_Master/Multimodal_BERT_output', type=str,
    ...
    nb_tr_steps = 0
    tr_loss = 0
    train_audio,valid_audio,test_audio= pickle.load(open('Multimodal_BERT_Master/data/audio/MOSI_cmu_audio_CLS.pickle','rb'))
    max_acc = 0
    min_loss = 100
    if args.do_train:
    ...
    if args.do_test:
        ...
        model = BertForSequenceClassification.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels = num_labels)
        model.load_state_dict(torch.load('Multimodal_BERT_Master/Multimodal_BERT_output/pytorch_model.bin'))
        model.to(device)
        model.eval()
...
if __name__ == "__main__":
    ...
    acc7_list = []
    for i in range(5):
        os.system('mkdir Multimodal_BERT_Master/Multimodal_BERT_output')
        results = main(i)
